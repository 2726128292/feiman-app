              ...
              <div class="flex-1 min-w-0">
                <div v-if="editingChapterId === chapter.id" class="flex items-center gap-1.5">
                  <input
                    ...
                    class="flex-1 px-2 py-1 text-sm font-semibold border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                ...
                <div v-if="expandedChapters.has(chapter.id)" class="mt-3 space-y-1.5">
                  ...
                  >
                    ...
                    <input
                      ...
                      class="flex-1 px-2 py-0.5 text-sm border border-blue-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500/20"
